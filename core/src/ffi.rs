...
>(
    ...
    linker.func_wrap("env", "random_range", random_range)?;
    linker.func_wrap("env", "random_f32", random_f32)?;
    linker.func_wrap("env", "random_f32_range", random_f32_range)?;
...
fn log_message<I: ConsoleInput, S, R: ConsoleRollbackState>(
    caller: Caller<'_, WasmGameContext<I, S, R>>,
    ptr: u32,
    len: u32,
) {
...
fn save<I: ConsoleInput, S, R: ConsoleRollbackState>(
    mut caller: Caller<'_, WasmGameContext<I, S, R>>,
    slot: u32,
    data_ptr: u32,
    data_len: u32,
...
fn load<I: ConsoleInput, S, R: ConsoleRollbackState>(
    mut caller: Caller<'_, WasmGameContext<I, S, R>>,
    slot: u32,
    data_ptr: u32,
    max_len: u32,
...
fn delete<I: ConsoleInput, S, R: ConsoleRollbackState>(
    mut caller: Caller<'_, WasmGameContext<I, S, R>>,
    slot: u32,
) -> u32 {
    let slot = slot as usize;
...
fn random_range<I: ConsoleInput, S, R: ConsoleRollbackState>(
    mut caller: Caller<'_, WasmGameContext<I, S, R>>,
    min: i32,
    max: i32,
) -> i32 {
...
fn random_f32<I: ConsoleInput, S, R: ConsoleRollbackState>(
    mut caller: Caller<'_, WasmGameContext<I, S, R>>,
) -> f32 {
...
fn random_f32_range<I: ConsoleInput, S, R: ConsoleRollbackState>(
    mut caller: Caller<'_, WasmGameContext<I, S, R>>,
    min: f32,
    max: f32,
) -> f32 {
