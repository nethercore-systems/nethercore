...
/// Type alias for the Emberware Z context used in FFI functions
pub type ZContext = WasmGameContext<ZInput, ZFFIState, ZRollbackState>;

/// Register all Emberware Z FFI functions with the linker
pub fn register_z_ffi(linker: &mut Linker<ZContext>) -> Result<()> {
