...
fn set_color(mut caller: Caller<'_, ZContext>, color: u32) {
...
fn depth_test(mut caller: Caller<'_, ZContext>, enabled: u32) {
    let state = &mut caller.data_mut().ffi;
...
fn cull_mode(mut caller: Caller<'_, ZContext>, mode: u32) {
    let state = &mut caller.data_mut().ffi;
...
fn blend_mode(mut caller: Caller<'_, ZContext>, mode: u32) {
    let state = &mut caller.data_mut().ffi;
...
fn texture_filter(mut caller: Caller<'_, ZContext>, filter: u32) {
    let state = &mut caller.data_mut().ffi;
...
fn uniform_alpha(mut caller: Caller<'_, ZContext>, level: u32) {
    let state = &mut caller.data_mut().ffi;
...
fn dither_offset(mut caller: Caller<'_, ZContext>, x: u32, y: u32) {
    let state = &mut caller.data_mut().ffi;
