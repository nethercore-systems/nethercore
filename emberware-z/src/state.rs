...
impl Default for ZFFIState {
    fn default() -> Self {
        Self {
            ...
            // Default sky: neutral gray gradient with white sun from above
            sky_horizon_color: [0.5, 0.5, 0.5],
            sky_zenith_color: [0.7, 0.7, 0.7],
            sky_sun_direction: [0.0, 1.0, 0.0],
            sky_sun_color: [1.0, 1.0, 1.0],
            sky_sun_sharpness: 64.0,
