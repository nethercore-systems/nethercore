//! Pattern builders for Nether Dawn composition
...
pub fn build_theme_a1_pattern(writer: &mut ItWriter, pat: u8) {
...
pub fn build_theme_a2_pattern(writer: &mut ItWriter, pat: u8) {
...
pub fn build_development_pattern(writer: &mut ItWriter, pat: u8) {
...
pub fn build_climax_pattern(writer: &mut ItWriter, pat: u8) {
