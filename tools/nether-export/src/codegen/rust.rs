...
//!
//! Generates a Rust module that loads assets from embedded nether binary data.
...
/// ```rust,ignore
/// //! Auto-generated by nether-export
///
/// mod assets {
///     // Embedded data
///     static PLAYER_MESH: &[u8] = include_bytes!("../assets/player.nczxmesh");
///     static PLAYER_TEX: &[u8] = include_bytes!("../assets/player.nczxtex");
///
///     extern "C" {
...
pub fn generate_rust_module(manifest: &Manifest, output_path: &Path) -> Result<()> {
    ...
    // Header
    code.push_str("//! Auto-generated by nether-export - DO NOT EDIT\n");
    code.push_str("//!\n");
