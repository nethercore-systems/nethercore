//! Mode 2 Inspector - Metallic-Roughness Blinn-Phong
//!
//! Demonstrates the debug inspection system for Mode 2 (MR-Blinn-Phong) rendering.
//! Mode 2 provides energy-conserving Blinn-Phong with metallic-roughness workflow.
//!
//! Features:
...
static mut POINT0_COLOR: u32 = 0xFFB480FF; // Orange
...
static mut POINT1_COLOR: u32 = 0x80FFB4FF; // Green
...
pub extern "C" fn init() {
    unsafe {
        ...
        LIGHT_INDICATOR_MESH = sphere(0.15, 8, 8); // Small sphere for light indicators
...
pub extern "C" fn render() {
    unsafe {
        ...
        // Draw light indicators (small emissive spheres at point light positions)
...
unsafe fn draw_ui() {
    // Title
    let title = b"Mode 2: MR-Blinn-Phong";
    ...
    // Material info
    let mat_info = b"Metallic-Roughness workflow";
    draw_text(mat_info.as_ptr(), mat_info.len() as u32, 10.0, 60.0, 14.0, 0xAAAAFFFF);
    ...
    let hint3 = b"F4: Debug Inspector (edit material, lights, sky)";
