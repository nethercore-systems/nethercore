...
//! and helper functions for building v2 128-bit EPU layer configurations.
//!
//! vNext extensions use the meta5 field (bits 52..48) for domain/variant encoding:
//! - meta5 = (meta_hi << 1) | meta_lo (5 bits total, 0..31)
//! - domain_id = (meta5 >> 3) & 0b11 (0..3)
//! - variant_id = meta5 & 0b111 (0..7)

// =============================================================================
// Helper Functions for v2/vNext 128-bit format
// =============================================================================

/// Build v2 hi word (bits 127..64 of the 128-bit layer)
///
/// Layout:
/// - bits 63..59: opcode     (5)
/// - bits 58..56: region     (3)
/// - bits 55..53: blend      (3)
/// - bits 52..49: meta_hi    (4) - vNext domain/variant (high bits)
/// - bit  48:     meta_lo    (1) - vNext domain/variant (low bit)
/// - bits 47..24: color_a    (24) - RGB24 primary color
/// - bits 23..0:  color_b    (24) - RGB24 secondary color
///
/// For v2 compatibility, set meta5 to 0 (pass 0 as the fourth parameter).
/// For vNext opcodes, use hi_meta() or compute meta5 = (domain_id << 3) | variant_id.
pub const fn hi(
    opcode: u64,
    region: u64,
    blend: u64,
...
/// Build vNext hi word with explicit domain and variant
///
...
/// Build v2 lo word (bits 63..0 of the 128-bit layer)
///
/// Layout:
...
pub const OP_LOBE: u64 = 0x02; // v2 position; vNext moves to 0x12
pub const OP_BAND: u64 = 0x03; // v2 position; vNext moves to 0x13
pub const OP_FOG: u64 = 0x04; // v2 position; vNext replaces with ATMOSPHERE at 0x0E
...
// =============================================================================
// vNext Enclosure Opcodes (0x02-0x07 in vNext mode)
// Note: Many constants are defined for documentation/future use
// =============================================================================
...
/// ATMOSPHERE - Advanced fog/scattering (replaces v2 FOG)
...
#[allow(dead_code)]
/// LOBE v2 - Directional glow (moved from v2 0x02)
pub const OP_LOBE_V2: u64 = 0x12;

#[allow(dead_code)]
/// BAND v2 - Horizon band (moved from v2 0x03)
pub const OP_BAND_V2: u64 = 0x13;
...
// Many constants defined for documentation/future use
// =============================================================================
