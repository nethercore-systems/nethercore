...
//   color_a: Wall/horizon color (RGB24)
//   color_b: Sky/ceiling color (RGB24)
//   param_a: Floor color R (0..255)
//   param_b: Floor color G (0..255)
//   param_c: Floor color B (0..255)
...
fn eval_ramp(
    ...
    // Extract colors directly from instruction
    let sky = instr_color_b(instr);
    let wall = instr_color_a(instr);

    // Floor color from param_a/b/c
    let floor = vec3f(
