...
fn eval_veil_curtains(
    ...
    let aa_width = 0.005;
    let ribbon_mask = 1.0 - smoothstep(base_thickness * 0.5 - aa_width, base_thickness + aa_width, min_dist);
    ...
    let glow = smoothstep(base_thickness * 3.0, base_thickness * 0.8, min_dist) * (1.0 - ribbon_mask);
