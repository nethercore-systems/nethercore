...
use crate::procedural::{self, MeshData, MeshDataTangent, MeshDataUV};
...
pub fn register(linker: &mut Linker<ZXGameContext>) -> Result<()> {
    ...
    linker.func_wrap("env", "sphere_tangent", sphere_tangent)?;
    linker.func_wrap("env", "plane_tangent", plane_tangent)?;
    linker.func_wrap("env", "cube_tangent", cube_tangent)?;
    linker.func_wrap("env", "torus_tangent", torus_tangent)?;
...
// ============================================================================
// Tangent-Enabled Procedural Shapes (Format 21: POS_UV_NORMAL_TANGENT)
// ============================================================================
