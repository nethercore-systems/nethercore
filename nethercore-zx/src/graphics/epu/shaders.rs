...
/// EPU bounds opcodes (modular files: RAMP, LOBE, BAND, FOG, etc.).
...
/// EPU feature opcodes (DECAL, GRID, SCATTER, FLOW, TRACE, VEIL, ATMOSPHERE, PLANE, CELESTIAL, PORTAL, LOBE_V2, BAND_V2) + dispatch entry.
