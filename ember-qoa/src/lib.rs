//! Ember-QOA: Modified QOA codec for Emberware
//!
//! This is a **modified** implementation of QOA (Quite OK Audio) tailored for
//! Emberware's fantasy consoles. It is NOT compatible with standard QOA files.
//!
...
//! (z-common's EmberZSoundHeader).
//!
//! # Differences from Standard QOA
//!
//! | Feature | Standard QOA | Ember-QOA |
//! |---------|--------------|-----------|
...
//!
//! Emberware uses a fixed sample rate (22050 Hz) controlled by the asset pipeline,
...
//!
//! ```
//! use ember_qoa::{encode_qoa, decode_qoa};
//!
...
mod tests {
    ...
    fn test_compression_ratio() {
        ...
        // Ember-QOA should achieve slightly better than 5:1 due to smaller headers
        assert!(
            ratio > 4.5,
