...
pub extern "C" fn epu_set(env_id: u32, config_ptr: [*]const u64) void;
...
pub extern "C" fn epu_draw(env_id: u32) void;
...
pub extern "C" fn epu_get_ambient(env_id: u32, normal_x: f32, normal_y: f32, normal_z: f32) u32;
