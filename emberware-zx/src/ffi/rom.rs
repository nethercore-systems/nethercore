...
fn read_string_id(caller: &Caller<'_, ZGameContext>, id_ptr: u32, id_len: u32) -> Option<String> {
...
fn rom_texture(mut caller: Caller<'_, ZGameContext>, id_ptr: u32, id_len: u32) -> Result<u32> {
...
///
/// **Init-only:** Can only be called during `init()`.
fn rom_mesh(mut caller: Caller<'_, ZGameContext>, id_ptr: u32, id_len: u32) -> Result<u32> {
...
fn rom_skeleton(mut caller: Caller<'_, ZGameContext>, id_ptr: u32, id_len: u32) -> Result<u32> {
...
fn rom_font(mut caller: Caller<'_, ZGameContext>, id_ptr: u32, id_len: u32) -> Result<u32> {
...
///
/// **Init-only:** Can only be called during `init()`.
fn rom_sound(mut caller: Caller<'_, ZGameContext>, id_ptr: u32, id_len: u32) -> Result<u32> {
...
fn rom_data_len(caller: Caller<'_, ZGameContext>, id_ptr: u32, id_len: u32) -> Result<u32> {
    let id = read_string_id(&caller, id_ptr, id_len)
