...
mod tests {
    ...
    #[test]
    fn test_header_size() {
        assert_eq!(EmberZTextureHeader::SIZE, 4);
    }
    ...
    fn test_header_parsing() {
        ...
        let header = EmberZTextureHeader::from_bytes(&data).unwrap();
    ...
    fn test_header_roundtrip() {
        let header = EmberZTextureHeader::new(128, 256);
        let bytes = header.to_bytes();
        let parsed = EmberZTextureHeader::from_bytes(&bytes).unwrap();
    ...
    #[test]
    fn test_rgba8_size() {
        let header = EmberZTextureHeader::new(64, 64);
    ...
    fn test_bc7_size_non_aligned() {
        ...
        let header = EmberZTextureHeader::new(30, 30);
