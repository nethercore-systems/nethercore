...
/// EmberZAnimation header (4 bytes)
///
...
mod tests {
    ...
    fn test_animation_header_roundtrip() {
        let header = EmberZAnimationHeader::new(25, 90);
    ...
    fn test_animation_header_size() {
        assert_eq!(EmberZAnimationHeader::SIZE, 4);
    ...
    fn test_animation_file_size() {
        ...
        let header = EmberZAnimationHeader::new(40, 60);
    ...
    fn test_header_validation() {
        let valid = EmberZAnimationHeader::new(10, 100);
        assert!(valid.validate());

        let invalid_bones = EmberZAnimationHeader::new(0, 100);
        assert!(!invalid_bones.validate());

        let invalid_frames = EmberZAnimationHeader::new(10, 0);
    ...
    fn test_single_frame_animation() {
        ...
        let header = EmberZAnimationHeader::new(1, 1);
        ...
        let parsed_header = EmberZAnimationHeader::from_bytes(&data).unwrap();
    ...
    fn test_max_bone_count() {
        // Maximum: 255 bones
        let header = EmberZAnimationHeader::new(255, 1);
    ...
    fn test_max_frame_count() {
        ...
        let header = EmberZAnimationHeader::new(1, 65535);
        assert!(header.validate());
